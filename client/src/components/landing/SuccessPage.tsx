...
const linkedInPosts = [
  ...
  },
  {
    ...
    likes: 99,
    content:
      "🏆 🏆 🏆 HUGE CONGRATS to the GDSC Gen AI Hackathon WINNERS!🏆 🏆 🏆 ",
  ...
  },
  {
    ...
    likes: 25,
    content:
      "Sumit and Yashi, two talented Solutions creators! Fantastic job.",
    author: "Chris Bennett",
    image:
      "https://media-exp1.licdn.com/dms/image/C5603AQHdFQvZ4zZJjw/profile-displayphoto-shrink_800_800/0/1626820190194?e=1637798400&v=beta&t=3Z4zZJjw",
    role: "Director of AI Transparency and Education @ XYZ Solutions",
    ...
    <Container>
      ...
      >
        ...
        <Typography variant="h5" style={{ margin: "1em 0" }}>
          🏆 Nested proudly won 1st place at the GDSC Gen AI Hackathon 2024!
          🏆
        </Typography>
        <Typography
          variant="body1"
        ...
        >
          <Link
            href="https://devpost.com/software/search?query=is%3Afeatured"
            target="_blank"
          ...
          <Link
            href="https://github.com/yashigupta4623"
            target="_blank"
            style={{ textDecoration: "none" }}
          >
            <Button
